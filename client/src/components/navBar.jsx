        ...
        <div className="flex justify-between items-center px-6 py-3 bg-white shadow-md relative font-sans">
            ...
            {isAuthenticated ? (
                <div className="relative" ref={dropdownRef}>
                    {/* Clickable Avatar */}
                    <div
                        className="w-11 h-11 flex items-center justify-center rounded-full bg-gradient-to-r from-purple-600 to-indigo-500 text-white font-bold text-lg cursor-pointer shadow-md hover:scale-105 transition-transform"
                ...
                <div className="flex gap-4">
                    <Button
                        text="Login"
                        styleContainer="bg-white font-bold text-indigo-600 border-2 border-indigo-600 hover:bg-indigo-50 transition-all px-5 py-2 rounded-md shadow-sm"
